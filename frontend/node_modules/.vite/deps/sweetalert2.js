...
var swalClasses = classNames.reduce((acc, className) => {
  acc[className] = swalPrefix + className;
  return acc;
}, {});
var icons = ["success", "warning", "info", "question", "error"];
var iconTypes = icons.reduce((acc, icon) => {
...
var shouldPreventTouchMove = (event) => {
  ...
  if (!isScrollable(container) && target instanceof HTMLElement && target.tagName !== "INPUT" && target.tagName !== "TEXTAREA" && !(isScrollable(htmlContainer) && htmlContainer.contains(target))) {
    return true;
  }
  return false;
};
