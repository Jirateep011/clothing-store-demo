...
async function decode(readable, options) {
  const { plugins } = options != null ? options : {};
...
function encode(input, options) {
  const { plugins, postPlugins, signal } = options != null ? options : {};
  const encoder2 = {
    deferred: {},
    index: 0,
...
async function loadRouteModule(route, routeModulesCache) {
  ...
  try {
    ...
    console.error(error);
    if (window.__reactRouterContext && window.__reactRouterContext.isSpaMode && import_meta.hot) {
      throw error;
    }
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
  ...
  let matchPathChanged = (match, index) => {
    var _a;
    return currentMatches[index].pathname !== match.pathname || ((_a = currentMatches[index].route.path) == null ? void 0 : _a.endsWith("*")) && currentMatches[index].params["*"] !== match.params["*"];
  };
  if (mode === "assets") {
...
function Meta() {
  ...
  return React9.createElement(React9.Fragment, null, meta.flat().map((metaProps) => {
    ...
    if ("charset" in metaProps) {
      (_a = metaProps.charSet) != null ? _a : metaProps.charSet = metaProps.charset;
...
var createRequestHandler = (build, mode) => {
  ...
  return async function requestHandler(request, loadContext = {}) {
    ...
    let manifestUrl = `${(_a = _build.basename) != null ? _a : "/"}/__manifest`.replace(
      /\/+/g,
      "/"
    );
    ...
    if (url.pathname.endsWith(".data")) {
      ...
      let criticalCss = mode === "development" ? await ((_c = (_b = getDevServerHooks()) == null ? void 0 : _b.getCriticalCss) == null ? void 0 : _c.call(_b, _build, url.pathname)) : void 0;
